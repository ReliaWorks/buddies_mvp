...
import { FullSizeImageModal } from '../../components/common';

const ggtcAffiliationImage = require('../../components/common/img/ggtc_logo.png');
const rrcaAffiliationImage = require('../../components/common/img/rrca_logo.png');

class Affiliation extends Component {
  state = { showModal: false, selectedImage: require('../../components/common/img/ggtc_logo.png') };
